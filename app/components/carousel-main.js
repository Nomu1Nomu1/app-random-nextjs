  ...
  return (
    <div className="carousel relative container mx-auto" style={{maxWidth: '1600px'}}>
        <div className="carousel-inner relative overflow-hidden w-full">
            ...
            <input className="carousel-open" type="radio" id="carousel-2" name="carousel" aria-hidden="true" hidden="{true}" defaultChecked/>
            <div className="carousel-item absolute opacity-0" style={{height: '50vh'}}>
            ...
            <input className="carousel-open" type="radio" id="carousel-3" name="carousel" aria-hidden="true" hidden="{true}" defaultChecked/>
            <div className="carousel-item absolute opacity-0" style={{height: '50vh'}}>
